      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center md:text-left md:flex-row md:items-center gap-12">
        ...
        <div className="space-y-6 max-w-lg mx-auto">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            ...
            <span className="text-[#71c088] font-semibold">Mana</span>. Discutons pour répondre à vos questions, explorer vos besoins, t vous aider à choisir l'offre idéale. Consultez moi, j’en serais ravi, c’est rapide, gratuit et sans aucune obligation !
          </p>
