...
const TeacherTutorials = () => {
  ...
  useEffect(() => {
    document.title = "Tutoriels Enseignant - Manamind";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background text-[#0c3d5e]">
      ...
      <div className="pt-20 pb-4">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-[#0c3d5e]/80">
            <Link to="/ressources" className="hover:text-[#0c3d5e] transition-colors">
              Ressources
            </Link>
            <span>→</span>
            <Link to="/tutorials" className="hover:text-[#0c3d5e] transition-colors">
              Tutoriels
            </Link>
            <span>→</span>
            <span className="text-[#0c3d5e]">Enseignant</span>
          </div>
        </div>
      </div>
      ...
      <section className="pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Button variant="ghost" size="sm" asChild className="mb-6">
            <Link to="/tutorials" className="text-[#0c3d5e]/80 hover:text-[#0c3d5e]">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-[#0c3d5e]/80">
              Welcome to this series of tutorials dedicated to getting started with Manamind.
            </p>
            <p className="text-[#0c3d5e]/80">
              Whether you're a new user or already familiar with the tool, this series will guide
              you step by step to help you make the most of all its features.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* <Footer />  // à remettre si tu ajoutes un composant Footer */}
    </div>
  );
};
