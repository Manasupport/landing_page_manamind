        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-[#0c3d5e]/80">
              Welcome to this series of tutorials designed to give you a smooth and enriching
              learning experience with Manamind!
            </p>
            <p className="text-[#0c3d5e]/80">
              Whether you're new to the platform or want to better understand its features, this
              series of videos will guide you step by step through your learning journey so you can
              make the most of it.
            </p>
          </div>
        </div>
