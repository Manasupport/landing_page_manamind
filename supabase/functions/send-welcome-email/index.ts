          ...
          <table align="center" width="100%" style="max-width: 600px; background: white; padding: 20px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
            ...
            <tr>
              <td align="center" style="padding-bottom: 20px;">
                <img src="https://lovable-uploads/Manamind.png" alt="Manamind Logo" width="150" style="display: block;">
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 20px; background-color: #f9f9f9; border-radius: 8px; margin: 20px;">
                <p style="color: #0c3d5e; font-size: 18px; font-weight: bold;">🛠️ Paramétrage de votre compte</p>
                <p style="color: #333; font-size: 14px;">
                  <strong>Si vous avez finalisé votre paiement</strong>, votre compte est en cours de configuration et sera paramétré sous 
                  <strong>24 heures ouvrées</strong>. Vous recevrez un email contenant <strong>votre lien d'accès</strong> pour débuter votre expérience Manamind.
                </p>
                <p style="color: #333; font-size: 14px;">⚠️ <strong>Utilisez impérativement l'adresse e-mail avec laquelle vous vous êtes inscrit(e)</strong> pour finaliser votre connexion.</p>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding: 20px 0; font-size: 14px; color: #666;">
                💬 Besoin d’aide ?  
                📩 Contactez-nous à <a href="mailto:contact@mana.fr" style="color: #71c088; text-decoration: none;">contact@mana.fr</a>  
                <br>Ou via le chat intégré dans votre espace Manamind.
              </td>
            </tr>
